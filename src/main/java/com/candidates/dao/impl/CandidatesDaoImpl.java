...
public class CandidatesDaoImpl extends JdbcDaoSupport implements CandidatesDao {
	...
	/* @description Returns Consent Type and Consent Email Body based on  language provided
	    * @param String country  
	    * @param String brand 
	    * @param String language Based on the language Consent Type and Email body is fetched 
